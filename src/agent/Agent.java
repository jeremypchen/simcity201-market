...
public abstract class Agent {
    ...
    public boolean isInterrupted() {
        return this.agentThread.isInterrupted();
    }
    /**
     * Pause/Resume agent scheduler thread.
     */
    public void pauseThread() {
    	agentThread.pause = true;
    }
    
    public void resumeThread() {
    	agentThread.pause = false;
    	agentThread.pauseSemaphore.release();
    }
        ...
        public void run() {
            ...
            while (goOn) {
                ...
                try {
                	...
                	System.out.println("InterrupedExcepted just went down!: " + e.toString());
                } catch (Exception e) {
